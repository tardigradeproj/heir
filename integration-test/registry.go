...
type pushOpt func(*pushOptions)

type pushOptions struct {
	skipPull bool
}

func withSkipPull() pushOpt {
	return func(o *pushOptions) { o.skipPull = true }
}

func pushImageToRegistry(sourceImage, targetRef string, registryPort uint32, opts ...pushOpt) (string, error) {
	o := &pushOptions{}
